...
const AppTextOTP = ({otp, setOtp} : authOtpProp) => {
    ...
    <SafeAreaView >
      ...
      <CodeField
        ...
        renderCell={({index, symbol, isFocused}) => (
          <Text
          className={`w-[52px] h-[52px] shadow bg-white rounded-lg items-center justify-center border text-[25px] border-indigo-600 ${isFocused && "border border-indigo-600" }text-center`}
            key={index}
             style={{
                display:"flex",
                textAlign:"center",

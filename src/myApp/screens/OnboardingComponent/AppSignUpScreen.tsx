...
const AppSignUpScreen = () => {
  ...
  return (
    <View className={`flex-1 w-screen `}>
      <View
        className={`w-full bg-white mb-0 pb-0  mx-auto  justify-center items-center `}
        style={{
      ...
      <View
        className={`bg-white rounded-tl-2xl px-8 pt-8 pb-8  rounded-tr-2xl  absolute bottom-0   w-full justify-end`}
        style={{
      ...
      >
        ...
        <View className="text-center">
          <AppTextContent
            ...
            classText="text-center text-neutral-400 text-2xl font-medium font-['SpaceGrotesk-Regular'] leading-loose  w-full"
            text={"Win cash completing bets using your favourite skill"}
          />
        </View>

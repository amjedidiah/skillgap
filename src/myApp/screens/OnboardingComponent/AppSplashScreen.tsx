  ...
  return (
    <View className='flex-1 w-screen flex  justify-center items-center bg-sky-600'>
       ...
       <Image
        ...
        className="w-[105px] h-[101.25px] relative  rounded-[10px]"
        />
       <View className="relative -top-[45px]  items-start">
       <Text className="text-white text-xl font-bold font-['Plus Jakarta Sans'] leading-[38px]">
            Skillgap
        </Text>
       </View>
       </View>

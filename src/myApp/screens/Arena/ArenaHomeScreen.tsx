...
const ArenaHomeScreen = () => {
  ...
  return (
    ...
    activeOpacity={0.8}
    className="flex-row items-center justify-center space-x-2 w-[161px] h-10 bg-gray-200 rounded-[10px]
    ">
    <Ionicons name="filter-outline" size={24} color="#6B7280" />
       <Text className="text-neutral-400 text-xs font-medium font-['GeneralSans-Regular'] leading-none">
        Categories
       </Text>
    </TouchableOpacity>
